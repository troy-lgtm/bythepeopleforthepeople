    ...
    <header className="sticky top-0 z-40 border-b border-record-200 bg-paper-50/92 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <Link href="/" className="flex shrink-0 items-center gap-3">
          ...
          <span>
            <span className="block whitespace-nowrap text-sm font-semibold tracking-wide text-ink-950">
              <span className="xl:hidden">By The People</span>
              <span className="hidden xl:inline">
                By The People, For The People
              </span>
            </span>
            <span className="block whitespace-nowrap text-xs text-ink-600">
