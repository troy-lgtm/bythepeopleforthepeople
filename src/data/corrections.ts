...
export const corrections: CorrectionLog[] = [
  {
    ...
    recordTitle: "Launch baseline",
    reportedBy: "Internal audit",
    description:
      "Public launch baseline. The corrections log is now live and will track every factual change made after publication: source URL updates, vote-count corrections, date corrections, jurisdiction corrections, and added context.",
